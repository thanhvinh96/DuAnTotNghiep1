    ...
    try {
      ...
      if (response) {
        ...
        setModalContent({
          title: "Thành công",
          body:
            "Người dùng đã được tạo thành công: " + response.result.tokenuser,
        });
        ...
        setModalContent({
          title: "Lỗi",
          body: "Không thể tạo người dùng. Vui lòng thử lại.",
        });
        MySwal.fire(
          "Lỗi",
      ...
      setModalContent({
        title: "Lỗi",
        body: "Đã xảy ra lỗi bất ngờ. Vui lòng thử lại.",
      });
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    >
                      ...
                      <option value="nurse">Tiếp Nhận</option>
              ...
              <Row>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <FileUploader
                      onFileUpload={(files) =>
                        handleFileUpload(files[0], "avatar")
                      }
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <FileUploader
                      onFileUpload={(files) =>
                        handleFileUpload(files[0], "imgidentification")
                      }
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <FileUploader
                      onFileUpload={(files) =>
                        handleFileUpload(files[0], "License")
                      }
                    />
                  </Form.Group>
                </Col>
