...
import { ShowMedicalByCode } from "../../controller/MedicalController";
    ...
    const fetchData = async () => {
      try {
        ...
        if (token) {
          ...
          const res = await ShowMedicalByCode(data);
          const parsedData = res['data'][0].newData;  // Accessing the newData array

          console.log("Medical Data: ", parsedData);
